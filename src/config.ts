...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: false,
    src: 'assets/images/DSwallpaper.webp', // Relative to the /src directory. Relative to the /public directory if it starts with '/'
  },
  favicon: [
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/jaerinkim', // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    // },
    {
      ...
      url: 'https://github.com/jaerinkim',
    },
  ],
}
